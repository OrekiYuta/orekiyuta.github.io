---
title: Sync Over RoboCopy
date: 2021-10-24 06:23:38
tags: [RoboCopy,LAN,Windows]
---

## Scene
- 基于 Windows 操作系统, NTFS 文件系统之间的文件同步
<!-- more -->

## Solution
- windows 自带的一个文件复制工具 robocopy
- 可用于日常的磁盘之间的文件备份/同步,设置个定时任务就很方便了
```
...
- 具体参数可参考以下
```
C:\Users\OrekiYuta>robocopy

-------------------------------------------------------------------------------
   ROBOCOPY     ::     Windows 的可靠文件复制
-------------------------------------------------------------------------------

  开始时间: 2021年10月24日 6:26:28
...
## Other
- 👉 [Docs/Windows Server/Windows 命令/服务器角色命令/robocopy](https://docs.microsoft.com/zh-cn/windows-server/administration/windows-commands/robocopy)
- 👉 [windows 备份杀手锏 robocopy 命令使用](https://outmanzzq.github.io/2018/09/30/robocopy-for-windows/)